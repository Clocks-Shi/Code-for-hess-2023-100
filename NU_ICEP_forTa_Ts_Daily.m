...
[data,~,data_text]=xlsread([in_path,'Ta_Ts_QHH_RS_NU.xlsx']);
...
%%
save([o_path,'NU_RS_data_ICE2003_2017'],'TdatePH','TdataPH');
save([o_path,'NU_RS_dataym_ICE2003_2017'],'T_IFym','T_ICym','LIF','LIC','T_IFystd','T_ICystd');