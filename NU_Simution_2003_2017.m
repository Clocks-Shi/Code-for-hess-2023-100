...
load([in_path,'NU_RS_data_ICE2003_2017.mat']);
...
for i=1:15
    for j = 1:3
       ...
       NU_E_Simu_sum(i,j)=xsum;
       NU_E_Simu_sum_d(i,j)=xsum-abs(xs05);
       NU_E_Simu_sum_u(i,j)=xsum+abs(xs95);
       
       NU_E_Simu_ym(i,j)=xmean;
       NU_E_Simu_ym_d(i,j)=xmean-abs(xm05);
       NU_E_Simu_ym_u(i,j)=xmean+abs(xm95);      
    end
end
%%
save([o_path,'NU_Models_E_2003_2017'],'NU_E_Simu_sum','NU_E_Simu_sum_d','NU_E_Simu_sum_u','NU_E_Simu_ym','NU_E_Simu_ym_d','NU_E_Simu_ym_u');
