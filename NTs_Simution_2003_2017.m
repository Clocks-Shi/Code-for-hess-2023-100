...
load([in_path,'NTs_RS_data_ICE2003_2017.mat']);
...
for i=1:15
    for j = 1:3
       ...
       NTs_E_Simu_sum(i,j)=xsum;
       NTs_E_Simu_sum_d(i,j)=xsum-abs(xs05);
       NTs_E_Simu_sum_u(i,j)=xsum+abs(xs95);
       
       NTs_E_Simu_ym(i,j)=xmean;
       NTs_E_Simu_ym_d(i,j)=xmean-abs(xm05);
       NTs_E_Simu_ym_u(i,j)=xmean+abs(xm95);      
    end
end
%%
save([o_path,'NTs_Models_E_2003_2017'],'NTs_E_Simu_sum','NTs_E_Simu_sum_d','NTs_E_Simu_sum_u','NTs_E_Simu_ym','NTs_E_Simu_ym_d','NTs_E_Simu_ym_u');
