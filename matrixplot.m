...
%  h1=axes('units','normalized','pos',[0.1,0.022,0.89,0.85]);
...
if strncmpi(ColorBar,'On',2)
    if any(strncmpi(FigStyle,{'Auto','Triu'},4))
        colorbar('Location','EastOutside', 'fontsize',14,'Fontname','Arial','FontWeight','bold');
    else
        colorbar('Location','SouthOutside', 'fontsize',14,'Fontname','Arial','FontWeight','bold');
    end
end
end
% ---------------------------------------------------
...
text(xtick,y,xstr,...
    'rotation',90,...
    'Interpreter','none',...
    'Fontname','Arail','fontsize',16,'FontWeigh','bold',...
    'color','k',...
