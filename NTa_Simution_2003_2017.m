...
load([in_path,'NTa_RS_data_ICE2003_2017.mat']);
...
for i=1:15
    for j = 1:3
       ...
       NTa_E_Simu_sum(i,j)=xsum;
       NTa_E_Simu_sum_d(i,j)=xsum-abs(xs05);
       NTa_E_Simu_sum_u(i,j)=xsum+abs(xs95);
       
       NTa_E_Simu_ym(i,j)=xmean;
       NTa_E_Simu_ym_d(i,j)=xmean-abs(xm05);
       NTa_E_Simu_ym_u(i,j)=xmean+abs(xm95);      
    end
end
%%
save([o_path,'NTa_Models_E_2003_2017'],'NTa_E_Simu_sum','NTa_E_Simu_sum_d','NTa_E_Simu_sum_u','NTa_E_Simu_ym','NTa_E_Simu_ym_d','NTa_E_Simu_ym_u');
