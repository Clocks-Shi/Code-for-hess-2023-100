...
for i =1:5
    for j = 1:5
     ...
     DyG_Seasonbox(i,j,1:length(Dyi(:,2)))=Dyi(:,2)';
    end
end
%%
H1=figure(1);
...
xlim([0.5 5.5])
 ...
 set(gca, 'FontSize',16,'YTick',0:0.5:5,'YTickLabel',{'0';'0.5';'1';'1.5';'2';'2.5';'3';'3.5';'4';'4.5';'5'});
...
box on
%%
print('-djpeg','-r600', [o_path,'FS2K_seasonal_E_box1']);
